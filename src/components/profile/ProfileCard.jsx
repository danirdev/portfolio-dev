...
export default function ProfileCard({ onOpenBio, onOpenContact }) {
  return (
    <div className="bg-white border-2 border-black p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-center">
      <div className="w-32 h-32 mx-auto bg-gray-100 border-2 border-black border-dashed mb-4 flex items-center justify-center overflow-hidden relative group">
      ...
      <div className="text-left space-y-2 border-t-2 border-dashed border-gray-300 pt-4 text-xs font-mono">
        ...
        <div className="flex justify-between">
          <span>STACK:</span>
          <span className="font-bold">REACT / NODE</span>
        </div>
        <div className="flex justify-between">
      ...
      <div className="mt-6 flex flex-col gap-2">
        <PixelButton onClick={onOpenBio} className="w-full justify-center">
          Ver Bio_Data
        </PixelButton>
        <PixelButton onClick={onOpenContact} className="w-full justify-center">
          Iniciar_Chat
        </PixelButton>
      </div>
    </div>
